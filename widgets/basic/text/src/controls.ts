...
export const controls = createControlPanel()
  ...
  .addStyleGroup((builder) => {
    builder
      ...
      .addColorPicker('backgroundColor', {
        label: 'widgets.thingsvis-widget-basic-text.label_50',
        default: 'transparent',
      })
      .addSlider('opacity', {
        label: 'widgets.thingsvis-widget-basic-text.label_51',
        min: 0,
        max: 1,
        step: 0.01,
        default: 1,
  ...
  .addAdvancedGroup((builder) => {
    builder
      .addSlider('padding', {
        label: 'widgets.thingsvis-widget-basic-text.label_58',
        min: 0,
        max: 100,
        default: 0,
      });
