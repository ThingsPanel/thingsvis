...
export const Main = defineWidget({
  ...
  locales: { zh, en },
  schema: PropsSchema,
  sampleData: { data: STANDALONE_UPLOT_SERIES },
  standaloneDefaults: { data: STANDALONE_UPLOT_SERIES },
  previewDefaults: { data: STANDALONE_UPLOT_SERIES },
  controls,
  render: (element: HTMLElement, props: Props, ctx: WidgetOverlayContext) => {
    ...
    const initChart = () => {
      ...
      emptyStateEl.textContent = hasData ? '' : runtimeMessages.runtime?.emptyState || 'No data';
