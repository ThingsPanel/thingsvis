...
<svg width="100%" height="100%" viewBox="0 -8 100 76" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" style="display:block">
  ...
  <!-- 左管道 -->
  <rect x="0" y="24" width="22" height="12" fill="url(#valvePipeGrad)"/>
  <line x1="0" y1="24" x2="22" y2="24" stroke="${lightenColor(pipeColor, 32)}" stroke-width="1"/>
  <line x1="0" y1="36" x2="22" y2="36" stroke="${darkenColor(pipeColor, 22)}" stroke-width="1"/>

  <!-- 左法兰 -->
  <rect x="20" y="19" width="6" height="22" rx="1" fill="url(#valveFlangeGrad)" stroke="#1e293b" stroke-width="1"/>
  <line x1="21.5" y1="22" x2="21.5" y2="38" stroke="${lightenColor(flangeColor, 22)}" stroke-width="0.8" opacity="0.6"/>

  <!-- 右管道 -->
  <rect x="78" y="24" width="22" height="12" fill="url(#valvePipeGrad)"/>
  <line x1="78" y1="24" x2="100" y2="24" stroke="${lightenColor(pipeColor, 32)}" stroke-width="1"/>
  <line x1="78" y1="36" x2="100" y2="36" stroke="${darkenColor(pipeColor, 22)}" stroke-width="1"/>

  <!-- 右法兰 -->
  <rect x="74" y="19" width="6" height="22" rx="1" fill="url(#valveFlangeGrad)" stroke="#1e293b" stroke-width="1"/>
  <line x1="78.5" y1="22" x2="78.5" y2="38" stroke="${lightenColor(flangeColor, 22)}" stroke-width="0.8" opacity="0.6"/>
