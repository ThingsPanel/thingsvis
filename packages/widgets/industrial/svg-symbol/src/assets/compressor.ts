export const FAN_SVG = `<svg width="100%" height="100%" viewBox="0 0 100 60" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="18" y="8" width="62" height="44" rx="4" fill="url(#fanHousing)" stroke="#1e293b" stroke-width="2"/>
  ...
  <line x1="24" y1="12" x2="74" y2="12" stroke="#1e293b" stroke-width="1" opacity="0.3"/>
  <line x1="24" y1="48" x2="74" y2="48" stroke="#1e293b" stroke-width="1" opacity="0.3"/>
</svg>`;
...
export const AIR_COMPRESSOR_SVG = `<svg width="100%" height="100%" viewBox="0 0 100 60" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="2" y="18" width="18" height="24" fill="#64748b"/>
  <rect x="80" y="18" width="18" height="24" fill="#64748b"/>
  <rect x="18" y="10" width="38" height="40" rx="4" fill="url(#acTankGrad)" stroke="#1e293b" stroke-width="2"/>
  <rect x="50" y="6" width="28" height="48" rx="2" fill="url(#acMotorGrad)" stroke="#1e293b" stroke-width="2"/>
