export const ELBOW_PIPE_SVG = `<svg width="100%" height="100%" viewBox="0 0 60 60" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <!-- Matches T-pipe horizontal main -->
    <linearGradient id="epHoriz" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%"   style="stop-color:#64748b;stop-opacity:1"/>
      <stop offset="42%"  style="stop-color:#94a3b8;stop-opacity:1"/>
      <stop offset="100%" style="stop-color:#334155;stop-opacity:1"/>
    </linearGradient>
    <!-- Matches T-pipe vertical branch -->
    <linearGradient id="epVert" x1="0%" y1="0%" x2="100%" y2="0%">
      <stop offset="0%"   style="stop-color:#64748b;stop-opacity:1"/>
      <stop offset="42%"  style="stop-color:#94a3b8;stop-opacity:1"/>
      <stop offset="100%" style="stop-color:#334155;stop-opacity:1"/>
    </linearGradient>
  ...
  <!-- Solid background to prevent any anti-aliasing seam cracks -->
  <path d="M 0 0 L 48 0 A 12 12 0 0 1 60 12 L 60 60 L 48 60 L 48 12 L 0 12 Z" fill="#334155"/>

  <!-- Top-Left Horizontal Half (45-degree miter cut) -->
  <path d="M 0 0 L 48 0 A 12 12 0 0 1 56.485 3.515 L 48 12 L 0 12 Z" fill="url(#epHoriz)"/>

  <!-- Bottom-Right Vertical Half (45-degree miter cut) -->
  <path d="M 48 12 L 56.485 3.515 A 12 12 0 0 1 60 12 L 60 60 L 48 60 Z" fill="url(#epVert)"/>
</svg>`;
