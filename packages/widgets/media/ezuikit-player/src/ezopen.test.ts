...
describe('ezopen url builder', () => {
  ...
  it('builds cloud storage url with begin only', () => {
    expect(
      buildCloudRecEzopenUrl({ serial: 'J33497314', channel: 1, hd: true }, '20260616000000'),
    ).toBe('ezopen://open.ys7.com/J33497314/1.hd.cloud.rec?begin=20260616000000');
  });
