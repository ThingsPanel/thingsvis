...
export const PropsSchema = z.object({
  ...
  title: z.string().default('容器').describe('props.title'),
  titleHeight: z.number().min(24).max(80).default(36).describe('props.titleHeight'),
  titleFontSize: z.number().min(10).max(32).default(14).describe('props.titleFontSize'),
  titleColor: z.string().default('').describe('props.titleColor'),
  titleBackgroundColor: z.string().default('transparent').describe('props.titleBackgroundColor'),
