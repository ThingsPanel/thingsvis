 ...
 * 
 * SDK for developing ThingsVis plugins with Builder Pattern and Zod integration.
 * 
 * 设计理念：
 * - 傻瓜式：definePlugin 一站式定义，零配置开箱即用
...
// 核心 API
// ============================================================================
export { definePlugin, type DefinePluginConfig } from './define-plugin';
